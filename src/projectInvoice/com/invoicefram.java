 ...
 */
 public class invoicefram extends JFrame implements ActionListener,ListSelectionListener {
    ...
    private void initComponents() {
        ...
        Invoivedatetextfield.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                InvoivedatetextfieldActionPerformed(evt);
            }
        });
    ...
    private void InvoivedatetextfieldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_InvoivedatetextfieldActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_InvoivedatetextfieldActionPerformed
        ...
        BufferedReader Itembr1 = new BufferedReader(new FileReader(file1));
           ...
           BufferedWriter Itembr2 = new BufferedWriter(Item1);
               ...
               for(InvoiceDetail item : main.getLines())
            {
                ...
                String Itemline=(main.getInvnumber()+","+item.getItemname()+","+item.getItemcount()+","+item.getItemprice()); 
         //      System.out.println("hiiiiiiiiiiiiiiiiiii"+Itemline);
